...
export function Toolbar({ text, onClear }: ToolbarProps) {
  ...
  return (
    <>
      <div className="sticky bottom-0 z-40 flex gap-3 border-t border-zinc-200 bg-white px-4 py-3 pb-safe dark:border-zinc-800 dark:bg-zinc-950">
        <button
          type="button"
          onClick={handleCopy}
          disabled={!text}
